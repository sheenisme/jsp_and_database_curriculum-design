...
%>
	<div class="container">
		...
		<div class="box">
				<div id="register_box">
					<h2>修改客户信息页面</h2>
					<form action="CustomServlet" method="post" name="registerform" onsubmit="return checkregister()">
						<input type="hidden" name="action" value="CustomUpdate">
						...
						<div class="ui register">	
						姓&nbsp;&nbsp;&nbsp;&nbsp;名:&nbsp;<input id="name" type="text" name="name" value="<%=vo.getName() %>"><br>
						</div>
						<div class="ui register">	
						...
						<div class="ui date">
						出生日期:&nbsp;<input class="Wdate" type="text" name="birthday" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})" value="<%=vo.getBirthday() %>">	
						</div>
						<input type="hidden" name="date" value="<%=vo.getDate() %>">	
						<input type="hidden" name="point" value="<%=vo.getPoint() %>">
						<div class="ui register">	
						单&nbsp;&nbsp;&nbsp;&nbsp;位:&nbsp;<input id="unit" type="text" name="unit" value="<%=vo.getUnit() %>"><br>
						</div>
						<div class="ui register">	
